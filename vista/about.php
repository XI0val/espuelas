  ...
  <div class="container section2 ">
     <div class="row">
       <div class="col-6 col-lg-6 col-md-8 col-xs-8 text-center mob20 wow slideInLeft intro1 " >
          <p class="introduccion">Nuestro pequeño criadero, Gahemor,  no es tan antiguo como las tierras  en el que se encuentra.
            ...
            Heredé  de mi padre la pasión  por la tierra, la naturaleza y los animales, especialmente los caballos.
              Él, a su vez, lo había heredado de sus abuelos que compraron estas hermosas tierras a principios del 1900, en la comuna de Santa Bárbara (Chile), 
              dejando este legado a hijos y nietos.<br>
        ...
        <div class="col-6 col-lg-4 col-md-6  mob20 wow zoomInRight img-intro">
